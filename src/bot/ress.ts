...
export class Ressources {
  // Bonk gif
  public static bonkEmbed = new EmbedBuilder().setImage(
    "https://c.tenor.com/yHX61qy92nkAAAAC/yoshi-mario.gif"
  );

  // Lizard gifs
  public static lizardEmbed = new EmbedBuilder().setImage(
    "https://media.tenor.com/xTyVDYFg_fsAAAAC/lizard-hehe.gif"
  );

  public static lizardEmbed2 = new EmbedBuilder().setImage(
    "https://media.tenor.com/msH3gTNQpwsAAAAd/lizards-chair-funny-animals.gif"
  );

  public static lizardEmbed3 = new EmbedBuilder().setImage(
    "https://media.tenor.com/TGUcc-bbevAAAAAC/lizard-cute.gif"
  );

  // Viktor
  public static viktor: string =
  ...
  public static botCommands: string =
