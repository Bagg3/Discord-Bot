...
// Bonk gif
Ressources.bonkEmbed = new EmbedBuilder()
    .setImage('https://c.tenor.com/yHX61qy92nkAAAAC/yoshi-mario.gif');
// Lizard gifs
Ressources.lizardEmbed = new EmbedBuilder()
    .setImage('https://media.tenor.com/xTyVDYFg_fsAAAAC/lizard-hehe.gif');
Ressources.lizardEmbed2 = new EmbedBuilder()
    .setImage('https://media.tenor.com/msH3gTNQpwsAAAAd/lizards-chair-funny-animals.gif');
Ressources.lizardEmbed3 = new EmbedBuilder()
    .setImage('https://media.tenor.com/TGUcc-bbevAAAAAC/lizard-cute.gif');
// Viktor
Ressources.viktor = 'https://img-9gag-fun.9cache.com/photo/a91WvPm_460s.jpg';
// Bot commands
Ressources.getBotCommands = 'Type .bot to get a list of commands';
Ressources.botCommands = "Type 'bagge' to get a bonk gif\nType 'EA' to get a random lizard gif\nType 'smartcast' for glorious evolution\n";
